...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                await e.reply("𝙽𝙾, 𝚃𝙷𝙸𝚂 𝙶𝚄𝚈 𝙸𝚂 𝙳𝙴𝚅𝙻𝙾𝙿𝙴𝚁 𝙾𝙵 wandering 𝙱𝙾𝚃 💘✨ .")
            elif uid == OWNER_ID:
                await e.reply("𝙽𝙾, 𝚃𝙷𝙸𝚂 𝙶𝚄𝚈 𝙸𝚂 𝙾𝚆𝙽𝙴𝚁 𝙾𝙵 wandering 𝙱𝙾𝚃 🌿✨")
            elif uid in SUDO_USERS:
                await e.reply("𝙽𝙾, 𝚃𝙷𝙸𝚂 𝙶𝚄𝚈 𝙸𝚂 𝚂𝚄𝙳𝙾 𝚄𝚂𝙴𝚁 𝙾𝙵 wandering 𝙱𝙾𝚃 💥⚡.")
            else:
