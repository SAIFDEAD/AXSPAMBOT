    ...
    if event.sender_id in SUDO_USERS:
        if event.reply_to_msg_id:
            ...
            if user_id in ALTRON:
                await event.reply("ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ 🇩𝜩Ⓐ︎🇩 ᴏᴡɴᴇʀ.")
            elif user_id == OWNER_ID:
                await event.reply("ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ ᴏᴡɴᴇʀ ᴏꜰ ᴅᴇᴀᴅ sᴘᴀᴍ.")
            elif user_id in SUDO_USERS:
                await event.reply("ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ ᴀ ꜱᴜᴅᴏ ᴜꜱᴇʀ ᴏꜰ ᴅᴇᴀᴅ sᴘᴀᴍ.")
            else:
                try:
